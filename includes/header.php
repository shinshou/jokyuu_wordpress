<div class="header-inner">
  <h1 class="site-ttl">
    <a href="<?php echo get_template_directory_uri(); ?>/index.html"><img src="<?php echo get_template_directory_uri(); ?>/asset/logo (2)@2x.png" alt="サイトロゴ"></a>
  </h1><!-- /.site-ttl -->
  <div class="nav-wrapper">
    <nav class="header-nav">
      ...
      <ul class="nav-list-r">
        ...
        <li class="nav-item">
          <a href="<?php echo get_template_directory_uri(); ?>/contact.html">資料請求</a>
        </li>
